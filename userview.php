...
<html>
    ...
    <body>
        ...
        $query = "SELECT * FROM member,member_details WHERE member.user_status = 0   and member.member_id=member_details.member_id";
                ...
                <div id='centerbox' class='centered text-center '>
                    <div id='rightsection'>
                        ...
                        <div id="how1">
                            ...
                            <form action="profilePicUpdate3.php" method="post" enctype="multipart/form-data">
                        ...
                        <div id="how2">
                            ...
                            <div id="section1">
                                <form class="comebesideme" action='editnewprofile.php' method='post'><input type='hidden' name='member_id' value='<?php echo $result['member_id']; ?>' />
                                    <input id='editprofile' type='submit' name='edithisprofile' value='Edit his Profile' />
                                </form>

                                &nbsp;&nbsp;&nbsp;
                                <form class="comebesideme" action='shoppingbagforuser.php' method='post'><input type='hidden' name='member_id' value='<?php echo $result['member_id']; ?>' />
                                    <input id='orderview' type='submit' name='viewhisorder' value='View his Order' />
                                </form>

                                &nbsp;&nbsp;&nbsp;
                                <form class="comebesideme" action='deleteaccount.php' method='post'><input type='hidden' name='member_id' value='<?php echo $result['member_id']; ?>' />
