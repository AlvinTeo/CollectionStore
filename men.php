...
<html>
    ...
    <center><div class="taskbar">MEN > <a class="insidetaskbar tobag">bags</a> > <a class="insidetaskbar towear">wears</a> > <a class="insidetaskbar toshoe">shoes</a> > <a class="insidetaskbar toaccessories">accessories</a></div></center>
    <center><div id="businessbag" class="styleproductstitle">Business Bag</div></center>
    <center><div class="taskbar">BAGS ><a class="insidetaskbar tobusinessbag">Business Bag</a> > <a class="insidetaskbar tobackpack">Back Pack</a> > <a class="insidetaskbar todocumentcase">Document Case</a> > <a class="insidetaskbar toluggage">Luggage</a></div></center>
            ...
            <?php foreach ($products1 as $product1) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product1['product_name']; ?>" />
            ...
            <?php foreach ($products2 as $product2) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product2['product_name']; ?>" />
    ...
    <center><div class="taskbar">MEN > <a class="insidetaskbar tobag">bags</a> > <a class="insidetaskbar towear">wears</a> > <a class="insidetaskbar toshoe">shoes</a> > <a class="insidetaskbar toaccessories">accessories</a></div></center>
    <center><div id="documentcase" class="styleproductstitle">Document Case</div></center>
    <center><div class="taskbar">BAGS ><a class="insidetaskbar tobusinessbag">Business Bag</a> > <a class="insidetaskbar tobackpack">Back Pack</a> > <a class="insidetaskbar todocumentcase">Document Case</a> > <a class="insidetaskbar toluggage">Luggage</a></div></center>
            ...
            <?php foreach ($products3 as $product3) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product3['product_name']; ?>" />
            ...
            <?php foreach ($products4 as $product4) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product4['product_name']; ?>" />
    ...
    <br>
    <center><div class="taskbar">MEN > <a class="insidetaskbar tobag">bags</a> > <a class="insidetaskbar towear">wears</a> > <a class="insidetaskbar toshoe">shoes</a> > <a class="insidetaskbar toaccessories">accessories</a></div></center>
    <center><div id="formalwear" class="styleproductstitle">Formal Wear</div></center>
    <center><div class="taskbar">WEARS > <a class="insidetaskbar toformalwear">Formal Wear</a> > <a class="insidetaskbar tocoat">Coats</a> > <a class="insidetaskbar tojacket">Jackets</a> > <a class="insidetaskbar topant">Pants</a> > <a class="insidetaskbar tojean">Jeans</a></div></center>
            ...
            <?php foreach ($products5 as $product5) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product5['product_name']; ?>" />
            ...
            <?php foreach ($products6 as $product6) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product6['product_name']; ?>" />
            ...
            <?php foreach ($products7 as $product7) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product7['product_name']; ?>" />
            ...
            <?php foreach ($products8 as $product8) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product8['product_name']; ?>" />
    ...
    <br>
    <center><div class="taskbar">MEN > <a class="insidetaskbar tobag">bags</a> > <a class="insidetaskbar towear">wears</a> > <a class="insidetaskbar toshoe">shoes</a> > <a class="insidetaskbar toaccessories">accessories</a></div></center>
    <center><div id="jean" class="styleproductstitle">Jeans</div></center>
    <center><div class="taskbar">WEARS > <a class="insidetaskbar toformalwear">Formal Wear</a> > <a class="insidetaskbar tocoat">Coats</a> > <a class="insidetaskbar tojacket">Jackets</a> > <a class="insidetaskbar topant">Pants</a> > <a class="insidetaskbar tojean">Jeans</a></div></center>
            ...
            <?php foreach ($products9 as $product9) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product9['product_name']; ?>" />
            ...
            <?php foreach ($products10 as $product10) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product10['product_name']; ?>" />
    ...
    <center><div class="taskbar">ACCESSORIES > <a class="insidetaskbar tosunglass">Sunglasses</a> > <a class="insidetaskbar tobelt">Belts</a> > <a class="insidetaskbar towallet">Wallet</a> > <a class="insidetaskbar towatch">Watch</a> > <a class="insidetaskbar toearphone">Earphone</a></div></center>
            ...
            <?php foreach ($products11 as $product11) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product11['product_name']; ?>" />
    ...
    <center><div class="taskbar">MEN > <a class="insidetaskbar tobag">bags</a> > <a class="insidetaskbar towear">wears</a> > <a class="insidetaskbar toshoe">shoes</a> > <a class="insidetaskbar toaccessories">accessories</a></div></center>
    <center><div id="belt" class="styleproductstitle">Belts</div></center>
    <center><div class="taskbar">ACCESSORIES > <a class="insidetaskbar tosunglass">Sunglasses</a> > <a class="insidetaskbar tobelt">Belts</a> > <a class="insidetaskbar towallet">Wallet</a> > <a class="insidetaskbar towatch">Watch</a> > <a class="insidetaskbar toearphone">Earphone</a></div></center>
            ...
            <?php foreach ($products12 as $product12) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product12['product_name']; ?>" />
            ...
            <?php foreach ($products13 as $product13) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product13['product_name']; ?>" />
            ...
            <?php foreach ($products14 as $product14) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product14['product_name']; ?>" />
    ...
    <center><div class="taskbar">MEN > <a class="insidetaskbar tobag">bags</a> > <a class="insidetaskbar towear">wears</a> > <a class="insidetaskbar toshoe">shoes</a> > <a class="insidetaskbar toaccessories">accessories</a></div></center>
    <center><div id="earphone" class="styleproductstitle">Earphone</div></center>
    <center><div class="taskbar">ACCESSORIES > <a class="insidetaskbar tosunglass">Sunglasses</a> > <a class="insidetaskbar tobelt">Belts</a> > <a class="insidetaskbar towallet">Wallet</a> > <a class="insidetaskbar towatch">Watch</a> > <a class="insidetaskbar toearphone">Earphone</a></div></center>
            ...
            <?php foreach ($products15 as $product15) : ?>
                <form class="orderAdd" method="post" action="orderAdd.php">
                    <li>
                        ...
                        <img class="allproducts" src="images/category_men/<?php echo $product15['product_name']; ?>" />
