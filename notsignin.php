...
<html>
    ...
    <body>
        <div class="cointainer text-center" style="margin-top: 100px;">
            <h2 class="hit-the-floor" style="color: red;
                font-weight: bold;
                font-family: Helvetica;
                text-shadow: 0 1px 0 #ccc, 0 2px 0 #c9c9c9, 0 3px 0 #bbb, 0 4px 0 #b9b9b9, 0 5px 0 #aaa, 0 6px 1px rgba(0,0,0,.1), 0 0 5px rgba(0,0,0,.1), 0 1px 3px rgba(0,0,0,.3), 0 3px 5px rgba(0,0,0,.2), 0 5px 10px rgba(0,0,0,.25), 0 10px 10px rgba(0,0,0,.2), 0 20px 20px rgba(0,0,0,.15);">
                You are not allowed to see your shopping bag before logged in</h2>
            <br>
            <a href="index.php"><button type="button" class="btn btn-danger">Back to Main Page</button></a>
        </div>
    </body>
</html>
