    ...
    <body>
        ...
        <div>
            <div id="theonlybox">    
                ...
                <form class="editprofile" name="editprofile" action="editprofileprocess.php" method="post">
                    ...
                    <fieldset class="fs5" id="f2">
                        ...
                        <input class="class2" id="yourDOB" name="yourDOB" placeholder="Ex: 1996-11-29" required type="date" min="1980-01-01" title="Please enter your date of birth" value="<?php echo $edit_dateofbirth; ?>" /><br />
                        <br />
                        <label class="class1"><span>*  </span>Mobile:</label>
                        <input class="class2" id="yourMobile" name="yourMobile" title="Please enter only number" placeholder="Ex: 08xxxxxxxx" pattern="[0-9]{9,}" required type="text" value="<?php echo $edit_mobile; ?>" /><br />
