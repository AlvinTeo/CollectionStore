...
<html>
    <head>
        ...
        <script src="javascript/delete2.js" type="text/javascript"></script>
...
<!--            <center><div class="taskbar"><a class="insidetaskbar" href="index.php">Homepage</a></div></center>-->
            ...
            <table>
                ...
                foreach ($result_array2 as $result2) :
                    ...
                    <tr>
                        ...
                        <td class="td4">
                            <form class='form'>  
                                <input type="hidden" name="product_id" id='product_id' class="product_id" value="<?php echo $result_array3['product_id']; ?>"/>
