...
if (isset($_SESSION['login_user'])) {
    echo '<a class="page-scroll" href="./logout.php"><img src="images/logout.png" style="width:30px;" /></a>';
} else {
    echo '<a class="page-scroll" href="#" id="loginform"><img src="images/loginuser.png" style="width:30px;" /></a>';
    ...
    echo '</div>';
    echo '</div>';
    echo '  <script src="javascript/loginjv.js" type="text/javascript"></script>';
}
?>
