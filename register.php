    ...
    <body>
        ...
        <div>
            <div id="theonlybox">    
                ...
                <form class="register" name="register" action="registerprocess.php" method="post">

                    <fieldset class="fs5" id="f1">

                        <label class="class1"><span>*  </span>Email:</label>
                        <input class="class2" id="registeremail" name="registeremail" autofocus placeholder="Email" required type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Please enter your email" /><br />
                        <br />
                        <label class="class1"><span>*  </span>Password:</label>
                        <input class="class2" id="registerpassword" name="registerpassword" placeholder="Password" required type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" /><br />
                        <br />
                        <label class="class1"><span>*  </span>Confirm Password:</label>
                        <input class="class2" id="confirmpassword" name="confirmpassword" placeholder="Confirm Password" required type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Please enter the same password" /><br />
                    ...
                    <fieldset class="fs5" id="f2">
                        ...
                        <input class="class2" id="yourFirstName" name="yourFirstName" placeholder="First Name" required type="text" title="Please enter your first name here" /><br />
                        <br />
                        <label class="class1"><span>*  </span>Your Lastname:</label>
                        <input class="class2" id="yourLastName" name="yourLastName" placeholder="Last Name" required type="text" title="Please enter your last name here" /><br />
                        <br />
                        <label class="class1"><span>*  </span>Date of Birth:</label>
                        <input class="class2" id="yourDOB" name="yourDOB" placeholder="Ex: 1996-11-29" required type="date" min="1980-01-01" title="Please enter your date of birth" /><br />
                        <br />
                        <label class="class1"><span>*  </span>Mobile:</label>
                        <input class="class2" id="yourMobile" name="yourMobile" placeholder="Ex: 08xxxxxxxx" pattern="[0-9]{9,}" title="Please enter only number" required type="text"/><br />
                    ...
                    <fieldset class="fs5" id="f3">
                        ...
                        <input class="class2" id="add1" name="add1" type="text" placeholder="Address Line 1" required /><br />
                        <br />
                        <label class="class1"><span>*  </span>Address Line 2:</label>
                        <input class="class2" id="add2" name="add2" placeholder="Address Line 2" required type="text" /><br />
                        <br />
                        <label class="class1"><span>*  </span>City:</label>
                        <input class="class2" id="city" name="city" placeholder="City" required type="text" title="City" /><br />
                        <br />
                        <label class="class1"><span>*  </span>Country:</label>
                        <select id="country" name="country">
                            <option selected="selected" value="select">Please select a county</option>
                    ...
                    <input class="btn btn-default center-block" type="submit" value="Register" id="submit" />
