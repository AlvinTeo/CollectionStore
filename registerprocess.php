...
if ($password == $confirmpassword) {
    ...
    if (!count($result_array1)) {
        ...
        $query3 = "INSERT INTO member_details (member_id,firstname,lastname,dateofbirth,mobile,addressline1,addressline2,city,country) VALUES
				((SELECT member_id from member WHERE email = '$email') , :firstname ,  :lastname , :dateofbirth, :mobile, :addressline1 , :addressline2, :city, :country)";
